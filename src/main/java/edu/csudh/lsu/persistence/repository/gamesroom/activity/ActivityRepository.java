...
public interface ActivityRepository extends JpaRepository<Activity, UUID> {
    ...
    @Modifying
    @Transactional
    @Query(value = "UPSERT INTO ACTIVITY (ACTIVITY, CATEGORY, PRICE, IMAGE_LOCATION, CREATED_TIME, CREATED_DATE, LAST_UPDATED_BY, ACCESSED_BY) " +
            "VALUES (:activity, :category, :price, :imageLocation, :createdTime, :createdDate, :lastUpdatedBy, :accessedBy)", nativeQuery = true)
    void upsertActivity(@Param("activity") String activity,
